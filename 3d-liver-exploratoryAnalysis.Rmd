...
# liverMarkerComments$liverMarker <- as.character(liverMarkerComments$liverMarker)


# create categories
# liverMarkerComments$liverMarkerComment <- as.factor(liverMarkerComments$liverMarkerComment)

commentsLiver <- liverMarkerComments %>%  group_by(liverMarkerComment) %>% summarise(n_unique = length(unique(study_ID))) %>%  arrange(desc(n_unique))
