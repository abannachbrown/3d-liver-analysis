...
#  colnames<-(t(t13_sorted[-1]), t13_sorted[,1]), 
 # 'labels' <- (t(t13_sorted[-1]), t13_sorted[,1])), 
  # t(as.matrix(t13_sorted)), 
   data_bar9,
  ylab = "Number of Studies", ylim=c(0, max(data_bar9) + 10), cex.names=1 , col = "#1f78b4",
  # main = "What kind of forms are printed with this ink?"
  ), 
...
formattable(commentsLiver,
            ...
            list(`Indicator Name` = formatter(
              ...
              "Number of Unique Studies"= color_bar("#1f78b4")
))
...
text(x = barplot(t10, ylab = "Number of Meta-Data Items", ylim=c(0, max(t10) + 10), cex.names=1, col = "#1f78b4"
