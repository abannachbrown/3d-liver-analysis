...
# Update the colors
fig_simple_styled <- fig_bioInk_simple %>% 
    style(fig_bioInk_simple, marker = list(colors = c("#a6611a","#dfc27d", "#80cdc1", "#018571"))) 
...
fig_suppl_styled <-  bioInk_count_suppl %>% 
    style(bioInk_count_suppl, marker = list(colors = c("#a6611a","#dfc27d", "#80cdc1", "#018571"))) 
